# Least Recently Used (LRU) cache using doubly linked list
...
class LRUCache:
    ...
    Additionally, in the case that the key already exists in the cache, we simply want to overwrite the old value associated with the key with
